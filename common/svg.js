...
export const Logo = (props) => (
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 40 40" {...props}>
    <path d="M20 40C9 40 0 31 0 19.9.1 8.9 9-.1 20.1 0 31.1.1 40 9 40 20.2 39.9 31.1 31 40 20 40" fillRule="evenodd" clipRule="evenodd" fill="currentColor" />
